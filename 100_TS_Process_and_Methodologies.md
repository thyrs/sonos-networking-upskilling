...
> __*ALERT: Knowing the **manufacturer** and **model** matters.  Some network devices are **not supported by Sonos**. you can check supported hardware here : https://support.sonos.com/en-us/article/incompatible-network-hardware*__
...
__*Alert: If you don’t understand how Sonos works, you’ll miss obvious problems. Review these **before troubleshooting**:*__
...
> __*In short: **observe → think → test → fix → confirm → record**.*__